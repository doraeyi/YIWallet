...
import { JobCoworkersDialog } from '@/components/sop/job-coworkers-dialog'
      ...
      <div className="flex flex-col gap-4 px-4 pb-6 lg:mx-auto lg:w-full lg:max-w-2xl lg:px-6">
        ...
        {!activeJob ? (
          <div className="flex flex-col items-center gap-2 py-10 text-center">
            ...
            <a href={`${process.env.NEXT_PUBLIC_WALLET_APP_URL}/settings`} className="text-xs text-amber-500 underline hover:text-amber-600">
              去設定頁新增工作，或請同事分享班表給你
            </a>
          </div>
        ) : deals.length === 0 ? (
